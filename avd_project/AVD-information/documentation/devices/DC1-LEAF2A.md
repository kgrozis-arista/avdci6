...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.50.0.11 | Port-Channel491 |
...
| Ethernet49/1 | MLAG_DC1-LEAF2B_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_DC1-LEAF2B_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_DC1-SPINE1_Ethernet3/1 | - | 10.20.0.31/31 | default | 1500 | False | - | - |
| Ethernet52/1 | P2P_DC1-SPINE2_Ethernet3/1 | - | 10.20.0.33/31 | default | 1500 | False | - | - |
| Ethernet53/1 | P2P_DC1-SPINE3_Ethernet3/1 | - | 10.20.0.35/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description MLAG_DC1-LEAF2B_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_DC1-LEAF2B_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
...
interface Ethernet53/1
   description P2P_DC1-SPINE3_Ethernet3/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.20.0.35/31
```
...
| Port-Channel491 | MLAG_DC1-LEAF2B_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_DC1-LEAF2B_Port-Channel491
   no shutdown
   switchport mode trunk
...
| 10.20.0.30 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.20.0.32 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.20.0.34 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.55.0.11 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65102
   ...
   neighbor 10.20.0.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.30 remote-as 65000
   neighbor 10.20.0.30 description DC1-SPINE1_Ethernet3/1
   neighbor 10.20.0.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.32 remote-as 65000
   neighbor 10.20.0.32 description DC1-SPINE2_Ethernet3/1
   neighbor 10.20.0.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.34 remote-as 65000
   neighbor 10.20.0.34 description DC1-SPINE3_Ethernet3/1
   neighbor 10.55.0.11 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.55.0.11 description DC1-LEAF2B_Vlan4093
