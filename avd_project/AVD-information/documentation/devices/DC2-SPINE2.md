...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_DC2-LEAF1A_Ethernet52/1 | - | 10.30.0.62/31 | default | 1500 | False | - | - |
| Ethernet2/1 | P2P_DC2-LEAF1B_Ethernet52/1 | - | 10.30.0.68/31 | default | 1500 | False | - | - |
| Ethernet3/1 | P2P_DC2-LEAF2A_Ethernet52/1 | - | 10.30.0.74/31 | default | 1500 | False | - | - |
| Ethernet4/1 | P2P_DC2-LEAF2B_Ethernet52/1 | - | 10.30.0.80/31 | default | 1500 | False | - | - |
...
interface Ethernet1/1
   description P2P_DC2-LEAF1A_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.30.0.62/31
!
interface Ethernet2/1
   description P2P_DC2-LEAF1B_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.30.0.68/31
!
interface Ethernet3/1
   description P2P_DC2-LEAF2A_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.30.0.74/31
!
interface Ethernet4/1
   description P2P_DC2-LEAF2B_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.30.0.80/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.10.2.9/32 |
...
| 10.30.0.63 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.30.0.69 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.30.0.75 | 65202 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.30.0.81 | 65202 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor 10.30.0.63 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.30.0.63 remote-as 65201
   neighbor 10.30.0.63 description DC2-LEAF1A_Ethernet52/1
   neighbor 10.30.0.69 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.30.0.69 remote-as 65201
   neighbor 10.30.0.69 description DC2-LEAF1B_Ethernet52/1
   neighbor 10.30.0.75 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.30.0.75 remote-as 65202
   neighbor 10.30.0.75 description DC2-LEAF2A_Ethernet52/1
   neighbor 10.30.0.81 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.30.0.81 remote-as 65202
   neighbor 10.30.0.81 description DC2-LEAF2B_Ethernet52/1
