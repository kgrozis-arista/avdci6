...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.50.0.10 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC1-HOST2 dual uplinks | *trunk | *10,20,30,50 | *4092 | *- | 1 |
| Ethernet49/1 | MLAG_DC1-LEAF2A_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_DC1-LEAF2A_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_DC1-SPINE1_Ethernet4/1 | - | 10.20.0.37/31 | default | 1500 | False | - | - |
| Ethernet52/1 | P2P_DC1-SPINE2_Ethernet4/1 | - | 10.20.0.39/31 | default | 1500 | False | - | - |
| Ethernet53/1 | P2P_DC1-SPINE3_Ethernet4/1 | - | 10.20.0.41/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description DC1-HOST2 dual uplinks
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description MLAG_DC1-LEAF2A_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_DC1-LEAF2A_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
...
interface Ethernet52/1
   ...
   mtu 1500
   no switchport
   ip address 10.20.0.39/31
!
interface Ethernet53/1
   description P2P_DC1-SPINE3_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.20.0.41/31
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | DC1-HOST2 LAG | trunk | 10,20,30,50 | 4092 | - | - | - | 1 | - |
| Port-Channel491 | MLAG_DC1-LEAF2A_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_DC1-LEAF2A_Port-Channel491
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.10.1.7/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 101.1.1.6/32 |
| Loopback6 | DIAG_VRF_Customer2 | Customer2 | 9.9.1.7/32 |
| Loopback7 | DIAG_VRF_Customer1 | Customer1 | 9.9.2.7/32 |
...
interface Loopback6
   ...
   no shutdown
   vrf Customer2
   ip address 9.9.1.7/32
!
interface Loopback7
   description DIAG_VRF_Customer1
   no shutdown
   vrf Customer1
   ip address 9.9.2.7/32
```
...
| Vlan3099 | Customer2 | 10.55.0.11/31 | - | - | - | - |
| Vlan3299 | Customer1 | 10.55.0.11/31 | - | - | - | - |
| Vlan4093 | default | 10.55.0.11/31 | - | - | - | - |
| Vlan4094 | default | 10.50.0.11/31 | - | - | - | - |
...
| 10.20.0.36 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.20.0.38 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.20.0.40 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.55.0.10 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.55.0.10 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Customer1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.55.0.10 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Customer2 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.10.1.7:10010 | 10010:10010 | - | - | learned |
| 20 | 10.10.1.7:10020 | 10020:10020 | - | - | learned |
| 30 | 10.10.1.7:20030 | 20030:20030 | - | - | learned |
| 50 | 10.10.1.7:10050 | 10050:10050 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| Customer1 | 10.10.1.7:300 | connected | - |
| Customer2 | 10.10.1.7:100 | connected | - |
...
router bgp 65102
   ...
   neighbor 10.20.0.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.36 remote-as 65000
   neighbor 10.20.0.36 description DC1-SPINE1_Ethernet4/1
   neighbor 10.20.0.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.38 remote-as 65000
   neighbor 10.20.0.38 description DC1-SPINE2_Ethernet4/1
   neighbor 10.20.0.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.20.0.40 remote-as 65000
   neighbor 10.20.0.40 description DC1-SPINE3_Ethernet4/1
   neighbor 10.55.0.10 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.55.0.10 description DC1-LEAF2A_Vlan4093
   ...
   vrf Customer1
      ...
      router-id 10.10.1.7
      neighbor 10.55.0.10 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.55.0.10 description DC1-LEAF2A_Vlan3299
   ...
   vrf Customer2
      ...
      router-id 10.10.1.7
      neighbor 10.55.0.10 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.55.0.10 description DC1-LEAF2A_Vlan3099
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
```eos
!
ip address virtual source-nat vrf Customer1 address 9.9.2.7
ip address virtual source-nat vrf Customer2 address 9.9.1.7
```
